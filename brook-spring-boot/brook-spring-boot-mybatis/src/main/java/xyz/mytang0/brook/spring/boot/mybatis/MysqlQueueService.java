...
public class MysqlQueueService implements QueueService {
    ...
    public void offer(String queueName, QueueMessage message) {
        xyz.mytang0.brook.spring.boot.mybatis.entity.QueueMessage
    ...
    public List<QueueMessage> poll(String queueName, int count, long timeout, TimeUnit unit) {
        ...
        List<xyz.mytang0.brook.spring.boot.mybatis.entity.QueueMessage> messages
    ...
    private xyz.mytang0.brook.spring.boot.mybatis.entity.QueueMessage convert(
            String queueName,
            QueueMessage message) {
        xyz.mytang0.brook.spring.boot.mybatis.entity.QueueMessage queueMessage =
                new xyz.mytang0.brook.spring.boot.mybatis.entity.QueueMessage();
